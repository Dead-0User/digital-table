          ...
          <div className="flex items-center justify-center h-96">
            <div className="text-center space-y-4">
              <div className="relative">
                <div className="h-16 w-16 rounded-2xl bg-gradient-to-br from-primary to-primary/50 mx-auto animate-pulse" />
                <Loader2 className="h-12 w-12 animate-spin text-primary absolute top-2 left-1/2 -translate-x-1/2" />
              </div>
