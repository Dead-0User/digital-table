                ...
                <div className="grid gap-4">
                  {section.items.length === 0 ? (
                    ...
                    section.items.map((item) => (
                      <div
                        key={item.id}
                        className={`flex items-center justify-between p-4 border border-border rounded-lg cursor-move hover:bg-muted/20 transition ${!item.isActive ? 'opacity-50' : ''}`}
                        draggable
                      ...
                      >
                        <div className="flex items-center space-x-4">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="font-semibold text-primary">{currency.symbol}{item.price.toFixed(2)}</p>
